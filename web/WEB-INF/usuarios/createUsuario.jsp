    ...
    <div class="container">
        <div class="intro-text left-0 text-center bg-faded p-5 rounded">
            <h2 class="section-heading mb-4">
                <span class="section-heading-upper">Agregar Usuario</span>
            </h2>
            <form action="crearUsuario" method="POST" id="registroUsuario">
                ...
                <table class="table table-borderless" style="width:100%;">
                    ...
                    <tr>
                        <td align="left">
                            ...
                            <br>
                            <input class="form-control" type="email" name="txtEmail" id="email" placeholder="correo electrónico" value="${usuario.email}">
                            <br>
                            <input class="form-control" type="password" name="txtPassword" id="password" placeholder="contraseña">
                            <br>
                            <input class="form-control" type="password" name="txtPasswordConfirm" id="passwordConfirm" placeholder="confirmar contraseña">
                            <br>
                        </td>
                        <td align="left">
                            <h5>Permisos</h5>
                ...
                <button class="btn btn-info" id="btnRegistrar" type="submit">Registrar</button>
            </form>
        </div>
    </div>
</section>
