  ...
  <div class="container">
    <div class="intro">
      ...
      <div class="intro-text left-0 text-center bg-faded p-5 rounded">
            <form action="login" method="post" name="FormEntrar">
                <h2 class="section-heading mb-4"><a href="#">Iniciar sesión</a></h2>
                <br>
                <input type="email" class="form-control" name="txtEmail" placeholder="correo electrónico" value="${email}" >
                <br>
                ...
                <br>
                <br>
                <a href="formIngresar.html"><span class="section-heading-upper">Crear una cuenta nueva</span></a>
            </form>
